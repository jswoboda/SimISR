...
if __name__== '__main__':
    ...
    centerstart = sp.array([0,0,400])    
    speed = sp.array([0,0,0]) #km/s
    rad = 35.0
    val = 5e10
    ...
    Icont1.savemat('patchexstation.mat')
    Icont2.savemat('patchexNEstation.mat')
    Icont3.savemat('patchexNE2stations.mat')