...
if __name__== '__main__':
    ...
    rangemat = np.repeat(range_vec[:,None],ang_data.shape[0],axis=1)
    ...
    sio.savemat(os.path.join(testpath,'ACFdata.mat'),mdict=DataLags)
    sio.savemat(os.path.join(testpath,'Noisedata.mat'),mdict=NoiseLags)